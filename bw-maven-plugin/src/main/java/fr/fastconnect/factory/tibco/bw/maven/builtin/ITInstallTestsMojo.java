 ...
 * 
 */
public class ITInstallTestsMojo extends AbstractWrapperForBuiltinMojo<Resource> {
	// Mojo configuration
	/**
	 ...
	 * 	&lt;role-hint>default-it-install-dependencies&lt;/role-hint>
	 * 	&lt;implementation>fr.fastconnect.factory.tibco.bw.maven.builtin.ITInstallTestsMojo
	 * 	&lt;/implementation>
	...
	protected Properties getConfiguration() {
		if (skipInstallation) {
			configuration.put("skipInstallation", true);
		}
